module.exports = [
"[project]/node_modules/ai/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_gateway3 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/gateway/dist/index.js [app-route] (ecmascript)");
var import_provider_utils34 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
// src/generate-text/generate-text.ts
var import_provider_utils10 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_gateway = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/gateway/dist/index.js [app-route] (ecmascript)");
// src/error/index.ts
...
var InvalidToolInputError = class extends import_provider4.AISDKError {
    constructor({ toolInput, toolName, cause, message = `Invalid input for tool ${toolName}: ${(0, import_provider4.getErrorMessage)(cause)}` }){
        super({
            name: name4,
            message,
            cause
...
var ToolCallRepairError = class extends import_provider10.AISDKError {
    constructor({ cause, originalError, message = `Error repairing tool call: ${(0, import_provider10.getErrorMessage)(cause)}` }){
        super({
            name: name9,
            message,
            cause
...
var import_provider_utils4 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
// src/util/detect-media-type.ts
var import_provider_utils = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
function detectMediaType({ data, signatures }) {
    ...
    const bytes = typeof processedData === "string" ? (0, import_provider_utils.convertBase64ToUint8Array)(processedData.substring(0, Math.min(processedData.length, 24))) : processedData;
...
var import_provider_utils2 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
// src/version.ts
...
var download = async ({ url })=>{
    ...
    try {
        const response = await fetch(urlText, {
            headers: (0, import_provider_utils2.withUserAgentSuffix)({}, `ai-sdk/${VERSION}`, (0, import_provider_utils2.getRuntimeEnvironmentUserAgent)())
        });
        if (!response.ok) {
...
var import_provider_utils3 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var dataContentSchema = import_v4.z.union([
    ...
    import_v4.z.custom(// Buffer might not be available in some environments such as CloudFlare:
    (value)=>{
        var _a16, _b;
...
var import_provider_utils5 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils6 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var jsonValueSchema = import_v42.z.lazy(()=>import_v42.z.union([
        import_v42.z.null(),
        import_v42.z.string(),
        import_v42.z.number(),
...
// src/types/provider-metadata.ts
var providerMetadataSchema = import_v43.z.record(import_v43.z.string(), import_v43.z.record(import_v43.z.string(), jsonValueSchema));
...
var imagePartSchema = import_v44.z.object({
    ...
    image: import_v44.z.union([
        dataContentSchema,
        import_v44.z.instanceof(URL)
    ]),
...
var outputSchema = import_v44.z.discriminatedUnion("type", [
    ...
    import_v44.z.object({
        ...
        value: import_v44.z.array(import_v44.z.union([
            import_v44.z.object({
                type: import_v44.z.literal("text"),
                text: import_v44.z.string()
            }),
...
var userModelMessageSchema = import_v45.z.object({
    ...
    content: import_v45.z.union([
        import_v45.z.string(),
        import_v45.z.array(import_v45.z.union([
            textPartSchema,
            imagePartSchema,
            filePartSchema
        ]))
...
var import_gateway2 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/gateway/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils7 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
async function _retryWithExponentialBackoff(f, { maxRetries, delayInMs, backoffFactor, abortSignal }, errors = []) {
    try {
        ...
        if (error instanceof Error && import_provider21.APICallError.isInstance(error) && error.isRetryable === true && tryNumber <= maxRetries) {
            await (0, import_provider_utils7.delay)(getRetryDelayInMs({
                error,
...
var import_provider_utils8 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils9 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
async function parseToolCall({ toolCall, tools, repairToolCall, system, messages }) {
    try {
        ...
        const parsedInput = await (0, import_provider_utils9.safeParseJSON)({
            text: toolCall.input
        });
...
async function doParseToolCall({ toolCall, tools }) {
    ...
    const parseResult = toolCall.input.trim() === "" ? await (0, import_provider_utils9.safeValidateTypes)({
        value: {},
        schema
    }) : await (0, import_provider_utils9.safeParseJSON)({
        text: toolCall.input,
        schema
    });
...
function createToolModelOutput({ output, tool: tool2, errorMode }) {
    if (errorMode === "text") {
        return {
            type: "error-text",
            value: (0, import_provider22.getErrorMessage)(output)
        };
...
async function generateText({ model: modelArg, tools, toolChoice, system, prompt, messages, maxRetries: maxRetriesArg, abortSignal, headers, stopWhen = stepCountIs(1), experimental_output: output, experimental_telemetry: telemetry, providerOptions, experimental_activeTools, activeTools = experimental_activeTools, experimental_prepareStep, prepareStep = experimental_prepareStep, experimental_repairToolCall: repairToolCall, experimental_download: download2, experimental_context, _internal: { generateId: generateId3 = originalGenerateId, currentDate = ()=>/* @__PURE__ */ new Date() } = {}, onStepFinish, ...settings }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils10.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
...
var import_provider_utils15 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils13 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
// src/ui-message-stream/ui-message-chunks.ts
var import_v47 = __turbopack_context__.r("[project]/node_modules/zod/dist/cjs/v4/index.js [app-route] (ecmascript)");
var import_provider_utils11 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
var uiMessageChunkSchema = (0, import_provider_utils11.lazyValidator)(()=>(0, import_provider_utils11.zodSchema)(import_v47.z.union([
        ...
        import_v47.z.strictObject({
            type: import_v47.z.custom((value)=>typeof value === "string" && value.startsWith("data-"), {
...
var import_provider_utils12 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
async function parsePartialJson(jsonText) {
    ...
    let result = await (0, import_provider_utils12.safeParseJSON)({
        text: jsonText
    });
    if (result.success) {
        return {
    ...
    result = await (0, import_provider_utils12.safeParseJSON)({
...
var import_provider_utils14 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var DefaultStreamTextResult = class {
  ...
  However, the LLM results are expected to be small enough to not cause issues.
    ...
    toUIMessageStream({ originalMessages, generateMessageId, onFinish, messageMetadata, sendReasoning = true, sendSources = false, sendStart = true, sendFinish = true, onError = import_provider23.getErrorMessage } = {}) {
...
// src/embed/embed.ts
var import_provider_utils16 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
async function embed({ model: modelArg, value, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers, experimental_telemetry: telemetry }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils16.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
    const baseTelemetryAttributes = getBaseTelemetryAttributes({
        model,
        telemetry,
        headers: headersWithUserAgent,
...
var import_provider_utils17 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
async function embedMany({ model: modelArg, values, maxParallelCalls = Infinity, maxRetries: maxRetriesArg, abortSignal, headers, providerOptions, experimental_telemetry: telemetry }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils17.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
    const baseTelemetryAttributes = getBaseTelemetryAttributes({
        model,
        telemetry,
        headers: headersWithUserAgent,
...
var import_provider_utils18 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
async function generateImage({ model: modelArg, prompt, n = 1, maxImagesPerCall, size, aspectRatio, seed, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils18.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
...
var import_provider_utils21 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils19 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var objectOutputStrategy = (schema)=>({
        ...
        async validateFinalResult (value) {
            return (0, import_provider_utils19.safeValidateTypes)({
                value,
                schema
            });
        },
    ...
    return {
        ...
        async validatePartialResult ({ value, latestObject, isFirstDelta, isFinalDelta }) {
            ...
            for(let i = 0; i < inputArray.length; i++){
                ...
                const result = await (0, import_provider_utils19.safeValidateTypes)({
                    value: element,
                    schema
                });
...
var import_provider_utils20 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
async function parseAndValidateObjectResult(result, outputStrategy, context) {
    const parseResult = await (0, import_provider_utils20.safeParseJSON)({
        text: result
    });
...
// src/generate-object/generate-object.ts
var originalGenerateId3 = (0, import_provider_utils21.createIdGenerator)({
    prefix: "aiobj",
    size: 24
});
async function generateObject(options) {
    ...
    const callSettings = prepareCallSettings(settings);
    const headersWithUserAgent = (0, import_provider_utils21.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
    const baseTelemetryAttributes = getBaseTelemetryAttributes({
        model,
        telemetry,
        headers: headersWithUserAgent,
...
var import_provider_utils23 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils22 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils24 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
async function generateSpeech({ model, text: text2, voice, outputFormat, instructions, speed, language, providerOptions = {}, maxRetries: maxRetriesArg, abortSignal, headers }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils24.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
    const { retry } = prepareRetries({
        maxRetries: maxRetriesArg,
        abortSignal
    });
...
var import_provider_utils25 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
var text = ()=>({
        type: "text",
        responseFormat: {
            type: "text"
...
var object = ({ schema: inputSchema })=>{
    ...
    return {
        ...
        async parseOutput ({ text: text2 }, context) {
            const parseResult = await (0, import_provider_utils25.safeParseJSON)({
                text: text2
            });
            if (!parseResult.success) {
                throw new NoObjectGeneratedError({
...
var import_provider_utils26 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
function smoothStream({ delayInMs = 10, chunking = "word", _internal: { delay: delay2 = import_provider_utils26.delay } = {} } = {}) {
    let detectChunk;
...
var import_provider_utils27 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
async function transcribe({ model, audio, providerOptions = {}, maxRetries: maxRetriesArg, abortSignal, headers }) {
    ...
    const headersWithUserAgent = (0, import_provider_utils27.withUserAgentSuffix)(headers != null ? headers : {}, `ai/${VERSION}`);
...
var import_provider_utils28 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
    ...
    try {
        ...
        const response = await fetch2(api, {
            ...
            headers: (0, import_provider_utils28.withUserAgentSuffix)({
                ...
                ...headers
            }, `ai-sdk/${VERSION}`, (0, import_provider_utils28.getRuntimeEnvironmentUserAgent)()),
...
// src/ui/chat.ts
var import_provider_utils31 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
...
var import_provider_utils30 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
// src/ui/http-chat-transport.ts
var import_provider_utils29 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
var HttpChatTransport = class {
    ...
    async sendMessages({ abortSignal, ...options }) {
        ...
        const response = await fetch2(api, {
            ...
            headers: (0, import_provider_utils29.withUserAgentSuffix)({
                "Content-Type": "application/json",
                ...headers
            }, `ai-sdk/${VERSION}`, (0, import_provider_utils29.getRuntimeEnvironmentUserAgent)()),
    ...
    async reconnectToStream(options) {
        ...
        const response = await fetch2(api, {
            method: "GET",
            headers: (0, import_provider_utils29.withUserAgentSuffix)(headers, `ai-sdk/${VERSION}`, (0, import_provider_utils29.getRuntimeEnvironmentUserAgent)()),
            credentials
        });
...
var AbstractChat = class {
    constructor({ generateId: generateId3 = import_provider_utils31.generateId, id = generateId3(), transport = new DefaultChatTransport(), messageMetadataSchema, dataPartSchemas, state, onError, onToolCall, onFinish, onData, sendAutomaticallyWhen }){
...
var import_provider_utils32 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
var import_v48 = __turbopack_context__.r("[project]/node_modules/zod/dist/cjs/v4/index.js [app-route] (ecmascript)");
var uiMessagesSchema = (0, import_provider_utils32.lazyValidator)(()=>(0, import_provider_utils32.zodSchema)(import_v48.z.array(import_v48.z.object({
        id: import_v48.z.string(),
        role: import_v48.z.enum([
            "system",
            "user",
            "assistant"
        ]),
        metadata: import_v48.z.unknown().optional(),
        parts: import_v48.z.array(import_v48.z.union([
            import_v48.z.object({
                type: import_v48.z.literal("text"),
                text: import_v48.z.string(),
                state: import_v48.z.enum([
                    "streaming",
                    "done"
                ]).optional(),
                providerMetadata: providerMetadataSchema.optional()
...
var import_provider_utils33 = __turbopack_context__.r("[project]/node_modules/ai/node_modules/@ai-sdk/provider-utils/dist/index.js [app-route] (ecmascript)");
function createUIMessageStream({ execute, onError = import_provider_utils33.getErrorMessage, originalMessages, onFinish, generateId: generateId3 = import_provider_utils33.generateId }) {
    let controller;
...
//# sourceMappingURL=node_modules_ai_dist_index_30a6bac2.js.map