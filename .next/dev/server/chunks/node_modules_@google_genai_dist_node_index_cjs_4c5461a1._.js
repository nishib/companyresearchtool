module.exports = [
"[project]/node_modules/@google/genai/dist/node/index.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var fs$1 = __turbopack_context__.r("[externals]/fs/promises [external] (fs/promises, cjs)");
var node_stream = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
var promises = __turbopack_context__.r("[externals]/node:stream/promises [external] (node:stream/promises, cjs)");
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */ /** Outcome of the code execution. */ exports.Outcome = void 0;
(function(Outcome) {
    /**
...
/** Programming language of the `code`. */ exports.Language = void 0;
(function(Language) {
    /**
...
/** Specifies how the response should be scheduled in the conversation. */ exports.FunctionResponseScheduling = void 0;
...
/** The type of the data. */ exports.Type = void 0;
(function(Type) {
    /**
...
/** The API spec that the external API implements. This enum is not supported in Gemini API. */ exports.ApiSpec = void 0;
(function(ApiSpec) {
    /**
...
/** Type of auth scheme. This enum is not supported in Gemini API. */ exports.AuthType = void 0;
(function(AuthType) {
...
/** The location of the API key. This enum is not supported in Gemini API. */ exports.HttpElementLocation = void 0;
...
/** Sites with confidence level chosen & above this value will be blocked from the search results. This enum is not supported in Gemini API. */ exports.PhishBlockThreshold = void 0;
...
/** The level of thoughts tokens that the model should generate. */ exports.ThinkingLevel = void 0;
...
/** Harm category. */ exports.HarmCategory = void 0;
...
/** Specify if the threshold is used for probability or severity score. If not specified, the threshold is used for probability score. This enum is not supported in Gemini API. */ exports.HarmBlockMethod = void 0;
...
/** The harm block threshold. */ exports.HarmBlockThreshold = void 0;
...
If empty, the model has not stopped generating the tokens. */ exports.FinishReason = void 0;
...
/** Output only. Harm severity levels in the content. This enum is not supported in Gemini API. */ exports.HarmSeverity = void 0;
...
/** Status of the url retrieval. */ exports.UrlRetrievalStatus = void 0;
...
/** Output only. The reason why the prompt was blocked. */ exports.BlockedReason = void 0;
...
/** Output only. The traffic type for this request. This enum is not supported in Gemini API. */ exports.TrafficType = void 0;
...
/** Tuning mode. This enum is not supported in Gemini API. */ exports.TuningMode = void 0;
(function(TuningMode) {
    /**
...
/** Adapter size for tuning. This enum is not supported in Gemini API. */ exports.AdapterSize = void 0;
...
/** Job state. */ exports.JobState = void 0;
(function(JobState) {
    /**
...
/** The tuning task. Either I2V or T2V. This enum is not supported in Gemini API. */ exports.TuningTask = void 0;
(function(TuningTask) {
    /**
     * Default value. This value is unused.
...
/** The tokenization quality used for given media. */ exports.PartMediaResolutionLevel = void 0;
...
/** Defines the function behavior. Defaults to `BLOCKING`. */ exports.Behavior = void 0;
(function(Behavior) {
    /**
     * This value is unused.
...
/** The environment being operated. */ exports.Environment = void 0;
...
/** Enum representing the editing mode. */ exports.EditMode = void 0;
(function(EditMode) {
...
/** Enum that represents the segmentation mode. */ exports.SegmentMode = void 0;
...
/** Enum for the reference type of a video generation reference image. */ exports.VideoGenerationReferenceType = void 0;
...
/** Enum for the mask mode of a video generation mask. */ exports.VideoGenerationMaskMode = void 0;
...
/** Enum that controls the compression quality of the generated videos. */ exports.VideoCompressionQuality = void 0;
...
/** Enum representing the tuning method. */ exports.TuningMethod = void 0;
...
/** State for the lifecycle of a Document. */ exports.DocumentState = void 0;
...
/** The reason why the turn is complete. */ exports.TurnCompleteReason = void 0;
...
/** Scale of the generated music. */ exports.Scale = void 0;
(function(Scale) {
    /**
     * Default value. This value is unused.
...
/** The mode of music generation. */ exports.MusicGenerationMode = void 0;
...
/** The playback control signal to apply to the music generation. */ exports.LiveMusicPlaybackControl = void 0;
...
*/ function flattenTypeArrayToAnyOf(typeList, resultingSchema) {
    ...
    if (listWithoutNull.length === 1) {
        resultingSchema['type'] = Object.values(exports.Type).includes(listWithoutNull[0].toUpperCase()) ? listWithoutNull[0].toUpperCase() : exports.Type.TYPE_UNSPECIFIED;
    } else {
        resultingSchema['anyOf'] = [];
        for (const i of listWithoutNull){
            resultingSchema['anyOf'].push({
                'type': Object.values(exports.Type).includes(i.toUpperCase()) ? i.toUpperCase() : exports.Type.TYPE_UNSPECIFIED
            });
        }
    }
}
    ...
    */ const incomingAnyOf = _jsonSchema['anyOf'];
    ...
    for (const [fieldName, fieldValue] of Object.entries(_jsonSchema)){
        ...
        if (fieldName == 'type') {
            ...
            genAISchema['type'] = Object.values(exports.Type).includes(fieldValue.toUpperCase()) ? fieldValue.toUpperCase() : exports.Type.TYPE_UNSPECIFIED;
...
exports.setDefaultBaseUrls = setDefaultBaseUrls; //# sourceMappingURL=index.cjs.map
}),
];

//# sourceMappingURL=node_modules_%40google_genai_dist_node_index_cjs_4c5461a1._.js.map