...
async function POST(request) {
    ...
    try {
        ...
        console.log(`[Recruiters API] Starting recruiter search for: ${companyName}`);
        researcher = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$scraper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CompanyResearcher"](false);
        await researcher.initialize();
        const recruiters = await researcher.extractRecruiters(companyName);
        await researcher.close();
        console.log(`[Recruiters API] Found ${recruiters.length} recruiters`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            recruiters,
            companyName,
        ...
        if (researcher) {
            try {
                ...
                console.error('[Recruiters API] Error closing researcher:', closeError);
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: errorMessage
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4499449._.js.map