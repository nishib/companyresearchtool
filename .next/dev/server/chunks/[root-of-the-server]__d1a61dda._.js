...
;
async function GET() {
    const hasLLMKey = !!(process.env.GOOGLE_API_KEY || process.env.ANTHROPIC_API_KEY || process.env.OPENAI_API_KEY);
    ...
    if (hasExaKey) {
        ...
        provider = process.env.GOOGLE_API_KEY ? 'Google Gemini' : process.env.ANTHROPIC_API_KEY ? 'Anthropic Claude' : 'OpenAI GPT';
