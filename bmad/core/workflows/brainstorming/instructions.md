...
<workflow>
<critical>The workflow execution engine is governed by: {project_root}/y/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project_root}/y/core/workflows/brainstorming/workflow.yaml</critical>
...
<invoke-task halt="true">{project-root}/y/core/tasks/advanced-elicitation.xml</invoke-task>
