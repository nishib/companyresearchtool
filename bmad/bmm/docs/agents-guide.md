...
**Customization Directory:** `{project-root}/y/_cfg/agents/`
...
# {project-root}/y/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: y/_cfg/agents/bmm-pm.customize.yaml
```
