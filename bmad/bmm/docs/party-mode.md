...
1. Party mode reads `y/_cfg/agent-manifest.csv`
...
Party mode uses agents from `y/[module]/agents/*.md` - these already include any customizations you applied during install.

**To customize agents for party mode:**

1. Create customization file: `y/_cfg/agents/bmm-pm.customize.yaml`
