...
<critical>You MUST have already loaded and processed: {project-root}/y/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/y/bmm/workflows/workflow-status">
